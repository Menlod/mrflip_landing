        ...
        <div className="mission__goallist">
          <div className="mission__goallist-item">
            ...
            <div className="mission__goallist-item-text">
              <div className="mission__goallist-item-text-title">Скорость</div>
              <div className="mission__goallist-item-text-descr">
                Сделки с недвижимостью за считанные дни — без ожиданий, звонков
                и волокиты.
              </div>
            </div>
          </div>
          <div className="mission__goallist-item">
            ...
            <div className="mission__goallist-item-text">
              <div className="mission__goallist-item-text-title">Простота</div>
              <div className="mission__goallist-item-text-descr">
                Оценка, документы и получение денег — в одном понятном цифровом
                процессе.
              </div>
            </div>
          </div>
