      ...
      <div className="aibot">
        ...
        <div className="aibot__container">
          ...
          <div className="aibot__text">
            ...
            позволяющий Вам наиболее выгодно распорядиться своими инвестициями в
            недвижимости.
          </div>
          <div className="aibot__text">
            Мы анализируем сотни торговых площадок и тысячи предложений
            ежедневно. Метод экстраполяции позволяет нам сделать для Вас лучшее
            предложение купли и продажи на рынке.
          </div>
